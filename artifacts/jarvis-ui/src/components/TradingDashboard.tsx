...
import {
  TrendingUp, TrendingDown, Activity, DollarSign, BarChart3, CandlestickChart, ArrowUpRight, ArrowDownRight, AlertTriangle, CheckCircle, XCircle, Clock, Zap, Shield, Brain, Target, Eye, Filter, Search, Download, Upload, RefreshCw, Settings, MoreVertical, ChevronDown, ChevronRight, Plus, Minus, Volume2, VolumeX, Bell, BellOff, Star, StarOff, Bookmark, BookmarkCheck, Info, HelpCircle, Layers, GitBranch, GitCommit, GitPullRequest, Database, Network, Cpu, HardDrive, MemoryStick, Thermometer, Radio, Signal, Wifi, WifiOff, Lock, Unlock, Key, Fingerprint, Scan, QrCode, Globe, MapPin, Navigation, Compass, Timer, TimerOff, TimerReset, Calendar, CalendarDays, CalendarCheck, CalendarClock, CalendarHeart, CalendarPlus, CalendarRange, CalendarSearch, CalendarX, AlarmClock, AlarmClockCheck, AlarmClockMinus, AlarmClockOff, AlarmClockPlus, BellRing, BellDot, BellMinus, BellPlus, MessageCircle, MessageCircleMore, MessageCircleHeart, MessageCircleOff, MessageCirclePlus, MessageCircleQuestion, MessageCircleX, MessagesSquare, Send, SendHorizontal, SendToBack, BringToFront, Move, Move3d, MoveDiagonal, MoveDiagonal2, MoveDown, MoveDownLeft, MoveDownRight, MoveHorizontal, MoveLeft, MoveRight, MoveUp, MoveUpLeft, MoveUpRight, MoveVertical, Navigation2, Navigation2Off, NavigationOff, Map, MapPinOff, MapPinned, Globe2, Earth, EarthLock, Satellite, SatelliteDish, Rocket, Plane, Train, TrainFront, Bus, BusFront, Car, CarFront, CarTaxiFront, Bike, Footprints, PersonStanding, Dumbbell, Weight, Scale, Scale3d, Ruler, Scissors, Hammer, Wrench, Nut, Bolt, Settings2, Sliders, SlidersHorizontal, SlidersVertical, ToggleLeft, ToggleRight, Delete, Trash, Trash2, Archive, ArchiveRestore, ArchiveX, Inbox, View, Inspect, SortAsc, SortDesc, ArrowUp, ArrowDown, ArrowLeft, ArrowRight, ArrowUpDown, ArrowLeftRight, ArrowLeftFromLine, ArrowLeftToLine, ArrowRightFromLine, ArrowRightToLine, ArrowUpFromLine, ArrowUpToLine, ArrowDownFromLine, ArrowDownToLine, ArrowBigUp, ArrowBigDown, ArrowBigLeft, ArrowBigRight, ArrowBigUpDash, ArrowBigDownDash, ArrowBigLeftDash, ArrowBigRightDash, CornerUpLeft, CornerUpRight, CornerDownLeft, CornerDownRight, RotateCw, RotateCcw, Rotate3d, FlipHorizontal, FlipVertical, Crop, Maximize, Minimize, Expand, Fullscreen, ZoomIn, ZoomOut, Focus, Crosshair, Locate, LocateOff, LocateFixed, MapPinCheck, MapPinX, MapPinPlus, MapPinMinus, MapPinHouse, Building, Building2, Hospital, School, University, Church, Castle, Tent, TreePalm, TreeDeciduous, Flower, Flower2, Leaf, Sprout, Wheat, Carrot, Apple, Banana, Grape, Cherry
} from "lucide-react";
import {
      ...
      <div className="h-80">
        <RechartsResponsiveContainer width="100%" height="100%">
          <RechartsComposedChart data={chartData}>
            ...
            <RechartsXAxis dataKey="time" stroke="rgba(255,255,255,0.3)" tick={{ fontSize: 10 }} />
            <RechartsYAxis stroke="rgba(255,255,255,0.3)" tick={{ fontSize: 10 }} domain={["auto", "auto"]} />
            <RechartsTooltip
              contentStyle={{
            ...
            {showBollinger && (
              <>
                <RechartsLine type="monotone" dataKey="bollingerUpper" stroke="rgba(168,85,247,0.5)" strokeWidth={1} dot={false} />
                <RechartsLine type="monotone" dataKey="bollingerLower" stroke="rgba(168,85,247,0.5)" strokeWidth={1} dot={false} />
              </>
            )}
            {showEMA && (
              <RechartsLine type="monotone" dataKey="ema20" stroke="rgba(234,179,8,0.8)" strokeWidth={2} dot={false} />
            )}
            <RechartsBar dataKey="volume" fill="rgba(6,182,212,0.3)" opacity={showVolume ? 1 : 0} />
...
const PortfolioChart: React.FC<{ allocation: PortfolioAllocation[] }> = ({ allocation }) => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-sm font-bold text-white tracking-wider flex items-center gap-2">
          <RechartsPieChart className="w-4 h-4 text-green-400" />
