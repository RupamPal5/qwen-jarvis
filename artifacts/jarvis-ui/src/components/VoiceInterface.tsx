...
import {
  Mic, MicOff, Volume2, VolumeX, AudioWaveform, Play, Pause, StopCircle, SkipForward, SkipBack, Repeat, Shuffle, Headphones, Radio, Podcast, Activity, Zap, Cpu, Brain, Network, Signal, Settings, Filter, Sliders, ChevronDown, ChevronUp, Maximize2, Minimize2, AlertCircle, CheckCircle, XCircle, Info, Clock, Timer, History, TrendingUp, Download, Upload, Save, Share2
} from "lucide-react";
import {
  LineChart as RechartsLineChart, Line as RechartsLine, XAxis as RechartsXAxis, YAxis as RechartsYAxis, CartesianGrid as RechartsCartesianGrid, Tooltip as RechartsTooltip, ResponsiveContainer as RechartsResponsiveContainer, AreaChart as RechartsAreaChart, Area as RechartsArea, BarChart as RechartsBarChart, Bar as RechartsBar, ComposedChart as RechartsComposedChart, ReferenceLine as RechartsReferenceLine, Legend as RechartsLegend
} from "recharts";
...
export default function VoiceInterface() {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6">
      ...
      {/* Main Visualization RechartsArea */}
