...
import {
  Fingerprint, Eye, Mic, Lock, Unlock, Shield, ShieldAlert, ShieldCheck, Key, KeyRound, Hash, Binary, Cpu, Activity, Zap, AlertTriangle, AlertCircle, CheckCircle, XCircle, Info, Clock, Terminal, Code, Bug, Check, X, ChevronRight, ChevronDown, MoreVertical, Settings, Bell, BellOff, BellRing, BarChart3, Wifi, WifiOff, Bluetooth, Usb, HardDrive, Thermometer, Fan, Power, Battery, BatteryCharging, Gauge, MemoryStick, Cloud, CloudOff, CloudUpload, CloudDownload, Share2, ExternalLink, Copy, Clipboard, Scissors, Save, FolderOpen, File, FileCode, FileText, Archive, Inbox, User, Users, Star, Heart, ThumbsUp, ThumbsDown, Award, Trophy, Target, Flag, MapPin, Navigation, Compass, Sun, Moon, CloudRain, CloudSnow, Flame, Snowflake, Umbrella, Wind, Droplets, Timer, TimerOff, TimerReset, Volume2, VolumeX, Camera, CameraOff, Video, VideoOff, Phone, Mail, AtSign, Code2, Braces, Command, GitBranch, GitCommit, GitPullRequest, Package, Box, Layers, Grid, List, Table, Columns, Rows, AlignLeft, AlignCenter, AlignRight, Bold, Italic, Underline, Strikethrough, Type, Heading, Sparkles, Wand2, Crown, Gem, Diamond, Feather, Anchor, Briefcase, Coffee, CupSoda, Pizza, Beer, Wine, Carrot, Apple, Banana, Grape, Cherry
} from "lucide-react";
import {
  PieChart as RechartsPie, Pie as RechartsPieSlice, Cell as RechartsCell, ResponsiveContainer as RechartsResponsiveContainer, Tooltip as RechartsTooltip, Legend as RechartsLegend
} from "recharts";
