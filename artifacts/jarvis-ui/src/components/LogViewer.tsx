...
import {
  FileText, Search, Filter, Download, Upload, Trash2, RefreshCw, Clock, AlertTriangle, AlertCircle, Info, CheckCircle, XCircle, Zap, Database, Server, Network, Terminal, Code, Braces, Activity, TrendingUp, TrendingDown, BarChart3, Calendar, Timer, Hash, Tag, Bookmark, Star, ChevronDown, ChevronRight, ChevronLeft, ChevronUp, Copy, Check, Eye, EyeOff, Maximize2, Minimize2, Play, Pause, SkipForward, SkipBack, RotateCcw, Layers, Box, Package, GitBranch, GitCommit, Cpu, MemoryStick, HardDrive, Wifi, WifiOff, Shield, Lock, Unlock, Key, Fingerprint, Bell, BellOff, Settings, MoreVertical, MoreHorizontal, ArrowUp, ArrowDown, ArrowLeft, ArrowRight, ZoomIn, ZoomOut, Focus, Target, Crosshair, Locate, MapPin, Globe, Satellite, Monitor, MessageSquare, Send, SendHorizontal, Users, User, UserCheck, UserX, Share2, Link as LinkIcon, Unlink, Save, FolderOpen, File, FileCode, Grid, Grid3X3, Columns, Rows, List, ListOrdered, CheckSquare, Square, Circle, Triangle, Sun, Moon, CloudRain, CloudSnow, Flame, Snowflake, Umbrella, TimerOff, TimerReset, Navigation, Navigation2, Compass, Map, MapPinned, Globe2, Earth, Rocket, Plane, Train, Bus, Car, Bike, Footprints, PersonStanding, Dumbbell, Weight, Scale, Ruler, Hammer, Wrench, Nut, Bolt, Settings2, Sliders, SlidersHorizontal, SlidersVertical, ToggleLeft, ToggleRight, Delete, Archive, ArchiveRestore, Inbox, View, SortAsc, SortDesc, RotateCw, Rotate3d, FlipHorizontal, FlipVertical, Expand, Fullscreen, Brain
} from "lucide-react";
import {
    ...
    <div className="bg-black/40 border border-white/10 rounded-xl p-4">
      ...
      <RechartsResponsiveContainer width="100%" height={200}>
        <RechartsAreaChart data={chartData}>
          ...
          />
          <RechartsArea type="monotone" dataKey="count" stroke="#a855f7" fill="rgba(168,85,247,0.3)" />
        </RechartsAreaChart>
...
const LevelDistributionChart: React.FC<{ logs: LogEntry[] }> = ({ logs }) => {
  ...
  return (
    <div className="bg-black/40 border border-white/10 rounded-xl p-4">
      ...
      <RechartsResponsiveContainer width="100%" height={200}>
        <RechartsPieChart>
          <RechartsPie data={data} cx="50%" cy="50%" innerRadius={50} outerRadius={80} paddingAngle={2} dataKey="count">
            {data.map((_, index) => (
