...
import {
  Sun, Moon, Sunrise, Sunset, Clock, Activity, Brain, Zap, Eye, EyeOff, Thermometer, ThermometerSun, ThermometerSnowflake, Wind, Droplets, Cloud, CloudRain, CloudSnow, CloudLightning, Flame, Snowflake, Umbrella, Lightbulb, Power, Battery, BatteryCharging, BatteryFull, Wifi, WifiOff, Signal, Radio, Bluetooth, Settings, Sliders, SlidersHorizontal, ToggleLeft, ToggleRight, CheckCircle, AlertCircle, Info, HelpCircle, Search, Filter, Download, Upload, Share2, ExternalLink, Copy, Clipboard, Scissors, Save, FolderOpen, File, FileText, FileCode, FileJson, FileImage, FileVideo, FileAudio, FileArchive, Trash, Trash2, Delete, Edit, Edit2, Edit3, Pencil, Pen, PenTool, Plus, Minus, MoreVertical, MoreHorizontal, Menu, ChevronRight, ChevronLeft, ChevronDown, ChevronUp, ArrowRight, ArrowLeft, ArrowDown, ArrowUp, RefreshCw, RotateCw, RotateCcw, Undo, Redo, Bell, BellRing, BellOff, BellDot, BellMinus, BellPlus, MessageSquare, MessageCircle, User, Users, UserCheck, UserX, UserPlus, UserMinus, Award, Trophy, Medal, Crown, Gem, Diamond, Target, Flag, Bookmark, Tag, Hash, AtSign, Phone, Mail, Binary, Code, Code2, Braces, Terminal, Command, GitBranch, GitCommit, GitPullRequest, Package, Box, Layers, Grid, List, Table, Columns, Rows, LayoutDashboard, LayoutGrid, LayoutList, LayoutTemplate, Layout, Folder, FileSpreadsheet, CloudUpload, CloudDownload, Link as LinkIcon, Unlink, Heart, Star, ThumbsUp, ThumbsDown, Home, Building, Factory, Warehouse, Store, Hospital, School, University, Church, Car, Bike, Train, Plane, Bus, Truck, Ship, MapPin, Navigation, Compass, Globe, Satellite, Cpu, MemoryStick, HardDrive, Server, Database, Network, Router, BarChart3, BarChart2, BarChart4, BarChartHorizontal
} from "lucide-react";
import {
  AreaChart as RechartsAreaChart, Area as RechartsArea, LineChart as RechartsLineChart, Line as RechartsLine, XAxis as RechartsXAxis, YAxis as RechartsYAxis, CartesianGrid as RechartsCartesianGrid, Tooltip as RechartsTooltip, ResponsiveContainer as RechartsResponsiveContainer, BarChart as RechartsBarChart, Bar as RechartsBar, ReferenceLine as RechartsReferenceLine, Cell as RechartsCell
} from "recharts";
