...
const getIconComponent = (iconName: string) => {
  const icons: Record<string, React.ComponentType<any>> = {
    ...
    GitMerge, Github, Gitlab, Bitbucket, BarChart3, RechartsBarChart, BarChart2,
    BarChart4, BarChartHorizontal, PieChart, PieChart2, RechartsLineChart, LineChart2,
    RechartsAreaChart, Radar, RadarChart, PolarGrid, PolarAngleAxis, PolarRadiusAxis,
    RechartsResponsiveContainer, RechartsCell, RechartsTooltip, RechartsLegend, RechartsArea, RechartsLine, RechartsXAxis, RechartsYAxis,
    RechartsCartesianGrid, ScatterChart, Scatter, ZAxis,
  };
