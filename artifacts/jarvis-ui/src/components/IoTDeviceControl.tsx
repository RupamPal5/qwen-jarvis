...
import {
  Smartphone, Laptop, Monitor, Tv, Watch, Tablet, Lightbulb, Thermometer, Droplets, Wind, Sun, Cloud, CloudRain, CloudSnow, CloudLightning, Snowflake, Flame, Power, Plug, Battery, BatteryCharging, BatteryFull, Wifi, WifiOff, Signal, Radio, Bluetooth, Lock, Unlock, Shield, ShieldAlert, ShieldCheck, Eye, EyeOff, Camera, Video, Mic, MicOff, Volume2, VolumeX, Music, Play, Pause, SkipForward, SkipBack, Repeat, Shuffle, Heart, Star, Bookmark, Home, Building, Factory, Warehouse, Store, Hospital, School, University, Church, Car, Bike, Train, Plane, Bus, Truck, Ship, MapPin, Navigation, Compass, Globe, Satellite, Activity, Zap, Cpu, MemoryStick, HardDrive, Server, Database, Network, Router, Search, Filter, SortAsc, SortDesc, Grid, List, Columns, Rows, Table, LayoutDashboard, LayoutGrid, LayoutList, LayoutTemplate, Layout, Box, Package, Layers, Folder, FolderOpen, File, FileText, FileCode, FileJson, FileImage, FileVideo, FileAudio, FileArchive, FileSpreadsheet, Download, Upload, CloudUpload, CloudDownload, Share2, ExternalLink, Link as LinkIcon, Unlink, Copy, Clipboard, Scissors, Save, SaveAll, Edit, Edit2, Edit3, Pencil, Pen, PenTool, Trash, Trash2, Delete, X, Plus, Minus, MoreVertical, MoreHorizontal, Menu, ChevronRight, ChevronLeft, ChevronDown, ChevronUp, ArrowRight, ArrowLeft, ArrowDown, ArrowUp, RefreshCw, RotateCw, RotateCcw, Undo, Redo, Settings, Settings2, Sliders, SlidersHorizontal, SlidersVertical, ToggleLeft, ToggleRight, Check, CheckCircle, CheckSquare, AlertCircle, AlertTriangle, AlertOctagon, Info, HelpCircle, Clock, Calendar, CalendarDays, CalendarCheck, CalendarClock, CalendarHeart, CalendarPlus, CalendarRange, CalendarSearch, CalendarX, Timer, TimerOff, TimerReset, Hourglass, Bell, BellRing, BellOff, BellDot, BellMinus, BellPlus, MessageSquare, MessageCircle, MessageCircleMore, MessageCircleHeart, MessageCircleOff, MessageCirclePlus, MessageCircleQuestion, MessageCircleX, MessagesSquare, Send, SendHorizontal, SendToBack, BringToFront, User, Users, UserCheck, UserX, UserPlus, UserMinus, UserCircle, UserSquare, UserCog, UserLock, UserSearch, Award, Trophy, Medal, Crown, Gem, Diamond, Target, Flag, Tag, Hash, AtSign, Phone, Mail, Binary, Code, Code2, Braces, Terminal, Command, GitBranch, GitCommit, GitPullRequest, GitMerge, Github, Gitlab, BarChart3, BarChart2, BarChart4, BarChartHorizontal, Moon
} from "lucide-react";
import {
    ...
    >
      ...
      <RechartsResponsiveContainer width="100%" height={250}>
        <RechartsAreaChart data={data}>
          ...
          />
          <RechartsArea type="monotone" dataKey="grid" stroke="#06b6d4" fillOpacity={1} fill="url(#colorGrid)" name="Grid" />
          <RechartsArea type="monotone" dataKey="solar" stroke="#fbbf24" fillOpacity={1} fill="url(#colorSolar)" name="Solar" />
        </RechartsAreaChart>
...
const getIconComponent = (iconName: string) => {
  const icons: Record<string, React.ComponentType<any>> = {
    Activity, AlertCircle, AlertOctagon, AlertTriangle, AtSign,
    Award, BarChart2, BarChart3, Battery, BatteryCharging, BatteryFull,
    Bell, BellDot, BellMinus, BellOff, BellPlus, BellRing,
    Bluetooth, Bookmark, Box, Braces, Building,
    Bus, Calendar, CalendarCheck, CalendarClock, CalendarDays,
    CalendarPlus, CalendarRange, CalendarSearch, CalendarX, Camera,
    Car, CheckCircle, CheckSquare, ChevronDown, ChevronLeft,
    ChevronRight, ChevronUp, Clipboard, Clock, Cloud,
    CloudDownload, CloudUpload, Code, Code2, Columns, Command,
    Compass, Copy, Cpu, Database, Download, Eye, EyeOff,
    File, FileCode, FileText, Filter, Flag, Folder, FolderOpen,
    GitBranch, GitCommit, GitMerge, GitPullRequest, Globe, HardDrive,
    Hash, Heart, HelpCircle, Home, Hourglass, Info, Laptop,
    Layers, Lightbulb, List, Lock, Mail, MapPin, MemoryStick,
    Menu, Mic, MicOff, Minus, Monitor, MoreHorizontal, MoreVertical,
    Music, Network, Package, Pause, Pen, Pencil, PenTool,
    Phone, Play, Plug, Plus, Radio, RefreshCw,
    Repeat, RotateCcw, RotateCw, Router, Save, Scissors, Search,
    Send, Server, Settings, Settings2, Shield, ShieldAlert, ShieldCheck,
    Ship, Shuffle, Signal, SkipBack, SkipForward, Sliders,
    SlidersHorizontal, Smartphone, Star, Sun, Table, Tag, Target,
    Terminal, Thermometer, Timer, ToggleLeft, ToggleRight, Train,
    Trash, Trash2, Tv, Unlink, Upload, Users, Video, Volume2,
    VolumeX, Watch, Wifi, WifiOff, Wind, X, Zap,
    MessageCircle, MessageCircleOff, MessageCirclePlus,
    MessageCircleQuestion, MessageCircleX, MessageSquare, Trophy,
    Plane, Truck, Share2, ExternalLink, Redo, Undo,
    ArrowDown, ArrowLeft, ArrowRight, ArrowUp, Tablet,
    School, Hospital, UserCheck, UserCog, UserMinus, UserPlus, UserX,
  };
