...
import {
  Settings, Brain, Shield, Palette, Network, Cpu, Wallet, Bell, Eye, Code, Save, RotateCcw, Search, ChevronRight, Zap, Lock, Globe, HardDrive, Database, Terminal, ToggleLeft, ToggleRight, Sliders, Volume2, VolumeX, Moon, Sun, Monitor, Smartphone, Tablet, Watch, Activity, AlertTriangle, CheckCircle, XCircle, Info, HelpCircle, RefreshCw, Download, Upload, Trash2, Key, Fingerprint, Wifi, WifiOff, Server, Cloud, CloudOff, GitBranch, Bug, Layers, Box, Package, Timer, Clock, Calendar, Mail, MessageSquare, Phone, Video, Mic, MicOff, Camera, CameraOff, MapPin, Navigation, Compass, Thermometer, Fan, Power, Battery, BatteryCharging, Gauge, MemoryStick, EyeOff, BellOff
} from "lucide-react";
