...
import {
  Brain, Network, Search, Filter, ZoomIn, ZoomOut, Maximize2, Minimize2,
  RotateCcw, Play, Pause, Settings, MoreVertical, Download, Upload,
  Share2, ExternalLink, Copy, Check, X, ChevronRight, ChevronDown,
  ChevronLeft, ChevronUp, ArrowRight, ArrowLeft, Plus, Minus,
  Eye, EyeOff, Lock, Unlock, Shield, ShieldAlert, ShieldCheck,
  Activity, Zap, Cpu, MemoryStick, HardDrive, Database, Server,
  Cloud, CloudOff, CloudUpload, CloudDownload, Wifi, WifiOff,
  Signal, Radio, Bluetooth, Usb, Thermometer, Fan, Power, Battery,
  Gauge, Tachometer, BarChart3, PieChart, LineChart, Radar,
  ...
  GitBranch, GitCommit, GitPullRequest, Package, Box, Layers,
  Grid, List, Table, Columns, Rows, LayoutDashboard, LayoutGrid,
  LayoutList, LayoutTemplate, Layout, Stack, Folder, FolderOpen,
  File, FileText, FileCode, FileJson, FileImage, FileVideo,
  FileAudio, FileArchive, FileSpreadsheet, FilePresentation,
  FileDocument, Trash, Trash2, Delete, Edit, Edit2, Edit3,
  Pencil, Pen, PenTool, Save, SaveAll, RefreshCw, RotateCw,
  RotateCcw as RotateCcwIcon, Undo, Redo, Sliders, SlidersHorizontal,
  SlidersVertical, ToggleLeft, ToggleRight, CheckCircle, CheckSquare,
  AlertCircle, AlertTriangle, AlertOctagon, Info, HelpCircle,
  HelpSquare, QuestionMark, Clock, Calendar, CalendarDays,
  CalendarCheck, CalendarClock, CalendarHeart, CalendarPlus,
  CalendarRange, CalendarSearch, CalendarX, Timer, TimerOff,
  TimerReset, Stopwatch, Hourglass, Bell, BellRing, BellOff,
  BellDot, BellMinus, BellPlus, Notification, NotificationOff,
  Notifications, NotificationsOff, MessageSquare, MessageCircle,
  MessageCircleMore, MessageCircleHeart, MessageCircleOff,
  MessageCirclePlus, MessageCircleQuestion, MessageCircleText,
  MessageCircleX, MessagesSquare, MessagesSquareMore,
  MessagesSquareHeart, MessagesSquareOff, MessagesSquarePlus,
  MessagesSquareQuestion, MessagesSquareText, MessagesSquareX,
  Send, SendHorizontal, SendToBack, BringToFront, User, Users,
  UserCheck, UserX, UserPlus, UserMinus, UserCircle, UserSquare,
  UserCog, UserLock, UserSearch, Award, Trophy, Medal, Crown,
  Gem, Diamond, Target, Flag, Bookmark, Tag, Hash, AtSign,
  Phone, Mail, Binary, Code, Code2, Braces, Terminal, Command,
  Github, Gitlab, Bitbucket, BarChart, BarChart2, BarChart4,
  BarChartHorizontal, PieChart2, LineChart2, AreaChart as AreaChartIcon,
  RadarChart, Sun, Moon, CloudRain, CloudSnow, CloudLightning,
  Wind, Droplets, Flame, Snowflake, Umbrella, CloudDrizzle,
  CloudFog, CloudHail, ThermometerSun, ThermometerSnowflake,
  ThermometerWind, Clock1, Clock2, Clock3, Clock4, Clock5,
  Clock6, Clock7, Clock8, AlarmClock, AlarmClockCheck,
  AlarmClockMinus, AlarmClockOff, AlarmClockPlus, BellRingOff,
  Home, Building, Factory, Warehouse, Store, Hospital, School,
  University, Church, Mosque, Synagogue, Temple, Castle, Fort,
  Lighthouse, Tent, TreePalm, TreeDeciduous, TreeConifer, Flower,
  Flower2, Leaf, Sprout, Wheat, Corn, Carrot, Apple, Banana,
  Orange, Lemon, Lime, Grape, Cherry, Peach, Pear, Plum,
  Watermelon, Strawberry, Blueberry, Raspberry, Blackberry, Kiwi,
  Mango, Pineapple, Coconut, Avocado, Tomato, Potato, Onion,
  Garlic, Pepper, Mushroom, Broccoli, Cauliflower, Lettuce,
  Spinach, Kale, Cabbage, Celery, Cucumber, Zucchini, Eggplant,
  Radish, Turnip, Beet, Parsnip, Fennel, Asparagus, Artichoke,
  BrusselsSprouts, BokChoy, Chard, CollardGreens, MustardGreens,
  TurnipGreens, BeetGreens, RadishGreens, CarrotGreens,
} from "lucide-react";
import {
  ...
  Legend as RechartsLegend, BarChart, Bar, XAxis as RechartsXAxis, YAxis as RechartsYAxis,
  CartesianGrid as RechartsCartesianGrid, AreaChart, Area, LineChart, Line,
} from "recharts";
