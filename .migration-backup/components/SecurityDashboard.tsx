...
import {
  Shield, ShieldAlert, ShieldCheck, Lock, Unlock, AlertTriangle, AlertCircle,
  Eye, EyeOff, Activity, Zap, Cpu, Network, Globe, Server, Database,
  Terminal, Code, Bug, BugOff, Scan, ScanLine, Search, Filter,
  Download, Upload, Trash2, RefreshCw, Play, Pause, Square,
  ChevronDown, ChevronRight, ChevronLeft, MoreVertical, Settings,
  Bell, BellOff, BellRing, XCircle, CheckCircle, Info, HelpCircle,
  TrendingUp, TrendingDown, BarChart3, PieChart as PieChartIcon, LineChart as LineChartIcon,
  Map, MapPin, Navigation, Compass, Satellite, Radio, Signal,
  Wifi, WifiOff, Bluetooth, Usb, HardDrive, MemoryStick, Thermometer,
  Fan, Power, Battery, BatteryCharging, Gauge, Tachometer,
  Key, Fingerprint, QrCode, Hash, Binary, GitBranch, GitCommit,
  FileText, FileCode, FileJson, Folder, FolderOpen, Archive,
  Clock, Timer, TimerOff, Stopwatch, Calendar, CalendarDays,
  User, Users, UserCheck, UserX, UserPlus, UserMinus,
  MessageSquare, Send, SendHorizontal, Mail, Phone, Video,
  Camera, CameraOff, Mic, MicOff, Volume2, VolumeX,
  Sun, Moon, Cloud, CloudOff, CloudRain, CloudSnow,
  Flame, Snowflake, Umbrella, Wind, Droplets,
  Rocket, Plane, Train, Bus, Car, Bike,
  Footprints, PersonStanding, Walking, Running,
  Swimming, Cycling, Dumbbell, Weight, Scale,
  ...
  Inbox, Drafts, Markunread, Unread, Read, Seen, Unseen,
  View, ViewOff, Show, Hide, Visibility, VisibilityOff,
  ZoomIn, ZoomOut, Focus, Target, Crosshair,
  Locate, LocateOff, LocateFixed, Maximize, Maximize2, Minimize, Minimize2,
  Expand, ExpandIcon, Collapse, CollapseIcon, Fullscreen, FullscreenOff,
  ExitFullscreen, EnterFullscreen, RotateCw, RotateCcw, Rotate3d,
  FlipHorizontal, FlipVertical, ArrowUp, ArrowDown, ArrowLeft, ArrowRight,
  ...
  Printer, Scan as ScanIcon, Share2, Share,
  Layers, Layer, Box, Package, BoxSelect, BoxIcon,
  Grid, Grid3X3, Columns, Rows, Table, List, ListOrdered,
  CheckSquare, Square as SquareIcon, Circle, Triangle, Hexagon, Octagon,
  Star, StarOff, Heart, ThumbsUp, ThumbsDown,
  Award, Trophy, Medal, Crown, Gem, Diamond,
  Gift, PartyPopper, Confetti, Coffee, Tea,
  Home, Building, Hospital, School, University, Bank,
  Store, ShoppingCart, CreditCard, Wallet, PiggyBank, Coins,
  ChartLine, ChartBar, ChartPie, Database as DbIcon,
  CloudUpload, CloudDownload, MessageCircle, ChatBubble,
  Envelope, PaperPlane, AlarmClock, Hourglass,
  CalendarEvent, UserGroup, Handshake, HandThumbUp,
  ShieldCheck as ShieldCheckIcon, BugAnt, CodeBracket,
  CommandLine, CpuChip, HandThumbUp as HandThumbUpIcon,
  EyeSlash, ShieldAlert as ShieldAlertIcon,
} from "lucide-react";
import {
    ...
    >
      ...
      <ResponsiveContainer width="100%" height={250}>
        <ComposedChart data={metrics}>
          ...
          <YAxis yAxisId="left" stroke="rgba(255,255,255,0.3)" tick={{ fontSize: 10 }} />
          <YAxis yAxisId="right" orientation="right" stroke="rgba(239,68,68,0.5)" tick={{ fontSize: 10 }} />
          <Tooltip
            contentStyle={{
          ...
          <Area yAxisId="left" type="monotone" dataKey="networkTraffic" stroke="#3b82f6" fill="rgba(59,130,246,0.2)" name="Traffic (MB)" />
          <Line yAxisId="right" type="monotone" dataKey="threatsBlocked" stroke="#ef4444" strokeWidth={2} dot={false} name="Threats Blocked" />
        </ComposedChart>
      </ResponsiveContainer>
    </motion.div>
  );
