...
import {
  Brain,Shield, Scale, Zap, AlertTriangle, CheckCircle, XCircle,
  Activity, TrendingUp, TrendingDown, BarChart3, Radar,
  Play, Pause, SkipForward, SkipBack, RotateCcw as RotateCcwIcon, FastForward,
  MessageSquare, Send, Eye, EyeOff, Lock, Unlock, Key,
  Cpu, Network, Database, Terminal, Code, Bug, BugOff,
  Search, Filter, Download, Upload, Trash2, RefreshCw,
  ChevronDown, ChevronRight, ChevronLeft, MoreVertical, Settings,
  Bell, BellOff, BellRing, X, Circle, Square as SquareIcon, Triangle,
  Hexagon, Octagon, Star, StarOff, Heart, ThumbsUp, ThumbsDown,
  Award, Trophy, Target, Flag, MapPin, Navigation, Compass,
  Globe, Satellite, Rocket, Plane, Train, Bus, Car, Bike,
  Footprints, PersonStanding, Walking, Running, Swimming, Cycling,
  Dumbbell, Weight, Scale as ScaleIcon, Ruler, Hammer, Wrench,
  Screwdriver, Nut, Bolt, Tool, Tools, Sliders, SlidersHorizontal,
  ToggleLeft, ToggleRight, Select, SelectAll, Deselect, ClearAll,
  Delete, Archive, ArchiveRestore, Inbox, Drafts, Markunread,
  Unread, Read, Seen, Unseen, View, ViewOff, Show, Hide,
  ...
  FlipHorizontal, FlipVertical, Reflect, ScaleIcon2, Crop, CropIcon,
  ...
  Pepper, Mushroom, Broccoli, Cauliflower, Lettuce, Spinach, Kale,
  Cabbage, Celery, Cucumber, Zucchini, Eggplant, Radish, Turnip, Beet,
  Parsnip, Fennel, Asparagus, Artichoke, BrusselsSprouts, BokChoy, Chard,
  CollardGreens, MustardGreens, TurnipGreens, BeetGreens, RadishGreens,
  CarrotGreens,
} from "lucide-react";
import {
  LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip,
  AreaChart, Area, BarChart, Bar, PieChart, Pie, Cell,
  ComposedChart, ReferenceLine, Legend, RadialBarChart, RadialBar,
  ScatterChart, Scatter, ZAxis, PolarGrid, PolarAngleAxis, PolarRadiusAxis, ResponsiveContainer,
  RadarChart,
} from "recharts";
    ...
    <div className="w-full h-64 bg-black/40 border border-white/10 rounded-xl p-4 backdrop-blur-xl">
      ...
      <ResponsiveContainer width="100%" height="100%">
        <RadarChart cx="50%" cy="50%" outerRadius="70%" data={data}>
          ...
          <Radar name="Influence" dataKey="A" stroke="#a855f7" fill="#a855f7" fillOpacity={0.3} />
        </RadarChart>
      </ResponsiveContainer>
    </div>
  );
