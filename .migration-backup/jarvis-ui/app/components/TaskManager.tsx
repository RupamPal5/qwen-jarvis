...
import {
  ...
  Edit, Check, X, ChevronDown, ChevronRight, ChevronLeft,
  Calendar, Clock, User, Users, Tag, Flag,
  AlertCircle, AlertTriangle, Info, CheckCircle,
  BarChart3, PieChart as PieChartIcon, TrendingUp,
  MoreVertical, MoreHorizontal, Copy, Link as LinkIcon,
  MessageSquare, FileText, Image, Video, Paperclip,
  Star, StarOff, Bookmark, Archive,
  Play, Pause, Square, RotateCcw,
  ArrowUp, ArrowDown, ArrowLeft, ArrowRight,
  GripVertical, Layers, List, Grid, Kanban,
  Timer, TimerOff, TimerReset, Stopwatch,
  Zap, Target, Trophy, Award,
  GitBranch, GitCommit, GitPullRequest, GitMerge,
  Database, Server, Cloud, CloudOff,
  Bell, BellOff, Settings, Sliders,
  Eye, EyeOff, Lock, Unlock,
  Folder, FolderOpen, FolderPlus,
  Hash, AtSign, DollarSign, Percent,
  Activity, TrendingDown, TrendingUp as TrendUp,
  CalendarDays, CalendarCheck, CalendarClock,
  UserCheck, UserX, UserPlus, UserMinus,
  Briefcase, Code, Design, Bug,
  Palette,
  Lightbulb, Rocket, Shield, Key,
  Mail, Phone, Globe, MapPin,
  Sun, Moon, Monitor, Smartphone,
  Cpu, MemoryStick, HardDrive, Network,
  Wifi, WifiOff, Bluetooth, Usb,
  Battery, BatteryCharging, Power,
  Thermometer, Fan, Gauge, Tachometer,
  Navigation, Compass, Map, MapPin as MapPinIcon,
  Satellite, SatelliteDish, Radio, Signal,
  Volume2, VolumeX, Mic, MicOff,
  Camera, CameraOff, Video as VideoIcon,
  Play as PlayIcon, Pause as PauseIcon,
  SkipForward, SkipBack, Repeat, Shuffle,
  Heart, ThumbsUp, ThumbsDown,
  Share2, ExternalLink, InternalLink,
  Save, SaveAll, FileSave,
  Printer, Scan, QrCode,
  ZoomIn, ZoomOut, Focus, Target as TargetIcon,
  Maximize, Maximize2, Minimize, Minimize2,
  Expand, Collapse, Fullscreen,
  RefreshCw, RefreshCcw, Loader,
  CheckSquare, Square as SquareIcon, Circle,
  ListOrdered, ListTodo, ListChecks,
  AlignLeft, AlignCenter, AlignRight,
  Bold, Italic, Underline, Strikethrough,
  Type, Heading, Paragraph,
  Code2, Braces, Terminal as TerminalIcon,
  Brain, Sparkles, Wand2, Magic,
  Crown, Gem, Diamond,
  Flame, Snowflake, Umbrella, CloudRain,
  Sun as SunIcon, Moon as MoonIcon, Star as StarIcon,
  Zap as ZapIcon, Bolt, Lightning,
  Rocket as RocketIcon, Plane, Train,
  Car, Bike, Footprints,
  Dumbbell, Weight, Scale,
  Hammer, Wrench, Screwdriver,
  Tool, Tools, Settings as SettingsIcon,
  Sliders as SlidersIcon, ToggleLeft, ToggleRight,
  Checkbox, Select,
  Input, Textarea, FormInput,
  Label, Badge, Tag as TagIcon,
  Folder as FolderIcon, File, FileText as FileTextIcon,
  Image as ImageIcon, Video as VideoFileIcon,
  Music, Film, Tv,
  Book, BookOpen, Library,
  GraduationCap, Award as AwardIcon, Trophy as TrophyIcon,
  Medal, Crown as CrownIcon,
  Gift, PartyPopper, Confetti,
  ...
  Dog, Cat, Bird,
  Tree, Flower, Leaf,
  Home, Building, Hospital,
  School, University, Bank,
  Store, ShoppingCart, CreditCard,
  Wallet, PiggyBank, Coins,
  ChartLine, ChartBar, ChartPie,
  Database as DbIcon, Server as ServerIcon,
  Cloud as CloudIcon, CloudUpload, CloudDownload,
  Upload as UploadIcon, Download as DownloadIcon,
  Share, Send, MessageCircle,
  ChatBubble, ChatBubbleOvalLeft, ChatBubbleLeftRight,
  Envelope, PaperPlane, Inbox,
  Bell as BellIcon, Notification,
  AlarmClock, Timer as TimerIcon2,
  Hourglass, HourglassTop, HourglassBottom,
  Calendar as CalendarIcon, CalendarEvent,
  User as UserIcon, UserGroup,
  Team, Users as UsersIcon,
  Handshake, HandThumbUp, HandThumbDown,
  Eye as EyeIcon, EyeSlash,
  Lock as LockIcon, Unlock as UnlockIcon,
  Key as KeyIcon, Fingerprint,
  Shield as ShieldIcon, ShieldCheck,
  Bug as BugIcon, BugAnt,
  Code as CodeIcon, CodeBracket,
  Terminal as TerminalIcon2, CommandLine,
  Cpu as CpuIcon, CpuChip,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-black/40 border border-white/10 rounded-xl p-4">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <PieChart>
              <Pie data={stats.priorityDistribution} cx="50%" cy="50%" innerRadius={50} outerRadius={80} paddingAngle={2} dataKey="count">
        ...
        <div className="bg-black/40 border border-white/10 rounded-xl p-4">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={stats.weeklyCompletion}>
              ...
              <XAxis dataKey="week" stroke="rgba(255,255,255,0.3)" tick={{ fontSize: 10 }} />
