...
import {
  Network, Cpu, Zap, Globe, Server, Database, Activity,
  TrendingUp, TrendingDown, ArrowUpRight, ArrowDownRight,
  CheckCircle, XCircle, AlertTriangle, Clock, Timer,
  RefreshCw, Settings, MoreVertical, ChevronDown, ChevronRight,
  Plus, Minus, Volume2, VolumeX, Bell, BellOff,
  Star, StarOff, Bookmark, BookmarkCheck, Info, HelpCircle,
  Layers, GitBranch, GitCommit, GitPullRequest,
  HardDrive, MemoryStick, Thermometer, Radio,
  Signal, Wifi, WifiOff, Lock, Unlock, Key, Fingerprint,
  Scan, QrCode, MapPin, Navigation, Compass,
  Calendar, CalendarDays, CalendarCheck, CalendarClock,
  AlarmClock, BellRing, MessageCircle, Send,
  Move, Move3d, MoveDiagonal, MoveHorizontal, MoveVertical,
  ZoomIn, ZoomOut, Focus, Target, Crosshair,
  Locate, LocateFixed, MapPinIcon, HomeIcon, Building,
  Hospital, School, University, Bank, Church,
  TreePalm, Leaf, Sprout, Wheat,
  Dumbbell, Weight, Scale, Ruler,
  Hammer, Wrench, Screwdriver, Nut, Bolt, Tool, Tools,
  Settings2, Sliders, SlidersHorizontal, ToggleLeft, ToggleRight,
  Select, SelectAll, Deselect, ClearAll,
  Delete, Trash, Trash2, Archive, ArchiveRestore,
  Inbox, SendIcon, Drafts,
  ...
  Eye, EyeOff, Scan as ScanIcon,
  Brain, Shield, Lock as LockIcon,
  Terminal, Code, MessageSquare,
