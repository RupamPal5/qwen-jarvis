  ...
  return (
    <div className="min-h-screen">
      <div className="container py-12">
        <h1 className="text-4xl font-bold mb-6">Dynamic Theme System</h1>
        <p className="text-lg mb-8">This page demonstrates the multi-theme system. Use the floating toggle button in the top-right corner to switch themes.</p>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="card">
            <h2 className="text-xl font-semibold mb-4">Desert Minimal</h2>
            <p className="mb-4">Warm beige, sand, soft white, subtle black accents.</p>
            <button className="button">Sample Button</button>
          </div>
          
          <div className="card">
            <h2 className="text-xl font-semibold mb-4">Night Sky</h2>
            <p className="mb-4">Deep navy, dark gray, subtle gradients, starry accents.</p>
            <button className="button">Sample Button</button>
          </div>
          
          <div className="card">
            <h2 className="text-xl font-semibold mb-4">Cyberpunk</h2>
            <p className="mb-4">Neon blue, purple, cyan, magenta, dark background.</p>
            <button className="button">Sample Button</button>
          </div>
        </div>
        
        <div className="card">
          <h2 className="text-xl font-semibold mb-4">Theme Features</h2>
          <ul className="list-disc pl-6 space-y-2">
            <li>Three distinct themes with carefully chosen color palettes</li>
            <li>Floating theme toggle button in top-right corner</li>
